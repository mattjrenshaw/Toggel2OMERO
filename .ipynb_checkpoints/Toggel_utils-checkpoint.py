...
def parse_header(header_str):
    ...
    Returns:
        Nested dictionaries: Each [SECTION] becomes a dictionary of key:value pairs for reading metadata values.
    """
...
def read_fli_file(file_path):
    ...
    Returns:
        header_metadata (nested dictionaries): key:value pairs for reading metadata values
